...
The project represents the art gallery page. The home and location page of the website are working. The website is compatible with mobile, tablet and desktop versions. The styling is consistent with the provided art gallery design.
...
- git clone git@github.com:Sajeelzafar/art_gallery.git
- cd art_gallery
